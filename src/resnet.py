...
def downsample_basic_block(x, planes, stride):
    ...
    zero_pads = torch.Tensor(out.size(0), planes - out.size(1), out.size(2), out.size(3), out.size(4)).zero_().cuda()
...
class ResNet3D(nn.Module):
    ...
    def __init__(self,
        ...
        self.fc = nn.Sequential(nn.Linear(self.fea_dim, 1024, bias=True))
